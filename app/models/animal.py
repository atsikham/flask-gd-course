...
class Animal(db.Model):
    ...
    specie_id = db.Column(db.String(80), db.ForeignKey('species.id'))

    def __init__(self, center_id, name, age, specie_id, description=None, price=None):
    ...
    def __str__(self):
        return '{} - {} - {}'.format(self.name, self.id, self.specie.name)
    ...
    @classmethod
    def add_animal(cls, center_id, name, age, specie_id, description=None, price=None):
        """
        Add new animal
        :param center_id:
        :param name:
        ...
        """
        new_animal = cls(center_id, name, age, specie_id, description, price)
    ...
    @classmethod
    def replace_animal(cls, animal_id, center_id, name, age, specie_id, description=None, price=None):
        """
        ...
        animal_to_replace.specie_id = specie_id
